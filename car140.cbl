      ...
      * car140 - test mainframe conversion to micro focus cobol
      * - capture parm-data from jcl // exec program,parm=xxx
      * this car140.cbl illustrates using a c subrtn
      * with call "GETPARM" using parm-data parm-lth
      * note - car140 is same as car130 (as of march 2005)
      * - added so crossref xcobcall1/2 would show 2 calls to getparm
       program-id. car130.
...
uvM    copy "unixwork1.cpy".
       01  page-hdngs.
           05 filler            pic x(40) value
              'CAR140: CUSTOMER NAME & ADDRESS LIST    '.
