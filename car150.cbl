      ...
      * - solicit report-date from console operator for report hdng
      * - also show run-date in page hdng (accept from  date)
      * - can also use this program to test file locking
      *   (run 1st jcl background, let wait, run 2nd jcl, observe lock)
       program-id. car150.
...
uvM    copy "unixwork1.cpy".
       01  page-hdngs.
           05 filler            pic x(40) value
              'CAR150: CUSTOMER NAME & ADDRESS LIST    '.
