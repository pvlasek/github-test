      ...
      *        - same as car100 with file status test
       program-id. car105.
...
uvM                       file status custmas-fstatus.
...
uvM        perform unixproc1.
       mainline.
           ...
           open input custmas.
           if custmas-fstatus not = "00"
              display "CUSTMAS OPEN ERR, FSTATUS = " custmas-fstatus
              stop run returning custmas-fstatus.
           open output nalist.
